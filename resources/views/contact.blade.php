...
<link rel="stylesheet" type="text/css" href="{{asset('public/User/styles/contact.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('public/User/styles/contact_responsive.css')}}">

<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url({{('public/User/images/light.jpg')}})"></div>
